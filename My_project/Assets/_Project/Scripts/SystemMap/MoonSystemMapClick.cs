...
{
    /// <summary>ЛКМ по луне в системной карте.</summary>
    [DisallowMultipleComponent]
    [RequireComponent(typeof(SelectableData))]
    public sealed class MoonSystemMapClick : MonoBehaviour
    {
        ...
        private void OnLeftClick()
        {
            ...
            UnityEngine.Debug.Log($"[SystemMap][Moon] Click | UID={_data.Uid.Type}/{_data.Uid.Id}", this);
        }
